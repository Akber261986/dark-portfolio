...
const Portfolio = () => {
  ...
  return (
    <div className="page-transition">
      ...
      {/* Project Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-16 px-16 sm:px-28">
        {filteredProjects.length > 0 ? (
          filteredProjects.map((project) => (
            <div
              key={project.id}
              className="group w-full h-[200px] relative cursor-pointer flex border rounded-lg shadow hover:shadow-lg transition"
      ...
      {isModalOpen && selectedProject && (
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-md flex justify-center items-center gap-4 z-50">
          <div className="flex flex-col bg-white dark:bg-gray-800 p-6 rounded-lg w-[55%] relative">
            <button
            ...
            <div className="grid lg:grid-cols-2 gap-3 mb-6 text-sm ">
